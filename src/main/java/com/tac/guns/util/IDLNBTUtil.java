...
public class IDLNBTUtil {
    ...
    // return new BlockPos(NBT.getDouble(ANCHOR_X), NBT.getDouble(ANCHOR_Y),
    // NBT.getDouble(ANCHOR_Z));
    // }
    //
    // public static BlockPos getMarkedPos2(ItemStack stack)
    // {
    // CompoundNBT NBT = IDLNBTUtil.getNBT(stack);
    // return new BlockPos(NBT.getDouble(ANCHOR_X_2), NBT.getDouble(ANCHOR_Y_2),
    // NBT.getDouble(ANCHOR_Z_2));
    // }
    //
