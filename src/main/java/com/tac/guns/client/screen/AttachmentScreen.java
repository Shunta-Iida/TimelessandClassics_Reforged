    ...
    protected void renderBg(PoseStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        if (this.minecraft.player.getMainHandItem().getItem() instanceof IEasyColor)
            ...
            for (int i = 9; i < IAttachment.Type.values().length; i++) {
                 ...
                 * {
                 * //this.blit(matrixStack, left + 10, top + 32 + i * 18, 176, 16 + i * 16, 16,
                 * 16);
                 * }
                 */
            }
        /*
         * else if((this.minecraft.player.getHeldItemMainhand().getItem() instanceof
         * TimelessOldRifleGunItem))
         * {
         * int iSkipper = 0;
         ...
         * {
         * this.blit(matrixStack, left + 5, top + 17 + iSkipper * 18, 176, 16 + iSkipper
         * * 16, 16, 16);
         * }
         * iSkipper++;
         * }
         ...
         * else if (i > 3)
         * {
         * this.blit(matrixStack, left + 155, top + 17 + i * 18, 176, 16 + (i-4) * 16,
         * 16, 16);
         * }
         * else if(this.weaponInventory.getStackInSlot(iSkipper).isEmpty())
         * {
         ...
         * {
         * this.blit(matrixStack, left + 11, top + 17 + i * 18, 176, 16 + i * 16, 16,
         * 16);
         * }
         * }
         */
