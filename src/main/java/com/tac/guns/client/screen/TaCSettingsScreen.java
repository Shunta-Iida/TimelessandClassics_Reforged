...
public class TaCSettingsScreen extends OptionsSubScreen {
    ...
    protected void init() {
        ...
        if (InputConstants.isRawMouseInputSupported()) {
            this.optionsList
                    .addSmall(Stream.concat(Arrays.stream(OPTIONS), Stream.of(new Option[] {})).toArray((p_96225_) -> {
        ...
        this.addRenderableWidget(
                new Button(this.width / 2 - 100, this.height - 27, 200, 20, CommonComponents.GUI_DONE, (p_96232_) -> {
                    this.options.save();
