...
public class ScopeAttachmentScreen extends AbstractContainerScreen<AttachmentContainer> {
    ...
    /*
     * @Override
     * protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int
     * mouseX, int mouseY)
     * {
     * Minecraft minecraft = Minecraft.getInstance();
     * this.font.draw(matrixStack, this.title, (float)this.titleX+30,
     ...
     * RenderSystem.translated(this.windowX + (this.mouseGrabbed &&
     * this.mouseGrabbedButton == 0 ? mouseX - this.mouseClickedX : 0), 0, 0);
     * RenderSystem.translated(0, this.windowY + (this.mouseGrabbed &&
     * this.mouseGrabbedButton == 0 ? mouseY - this.mouseClickedY : 0), 0);
     * RenderSystem.rotatef(-30F, 1, 0, 0);
     * RenderSystem.rotatef(this.windowRotationY - (this.mouseGrabbed &&
     * this.mouseGrabbedButton == 1 ? mouseY - this.mouseClickedY : 0), 1, 0, 0);
     * RenderSystem.rotatef(this.windowRotationX + (this.mouseGrabbed &&
     * this.mouseGrabbedButton == 1 ? mouseX - this.mouseClickedX : 0), 0, 1, 0);
     * RenderSystem.rotatef(150F, 0, 1, 0);
     * RenderSystem.scalef(this.windowZoom / 10F, this.windowZoom / 10F,
     * this.windowZoom / 10F);
     ...
     * I18n.format("container.tac.attachments.window_help"), 56, 38, 0xFFFFFF);
     * RenderSystem.popMatrix();
     * }
     * }
     */
