...
public final class Keys {
    ...
    static {
        ...
        /*
         * SHIFTY = new TacKeyBuilder( "key.tac.ss" ).withKeyboardKey(
         * InputConstants.KEY_LSHIFT ).buildAndRegis();
         * CONTROLLY = new TacKeyBuilder( "key.tac.cc" ).withKeyboardKey(
         * InputConstants.KEY_LCONTROL ).buildAndRegis();
         * ALTY = new TacKeyBuilder( "key.tac.aa" ).withKeyboardKey(
         * InputConstants.KEY_LALT ).buildAndRegis();
         * SHIFTYR = new TacKeyBuilder( "key.tac.ssr" ).withKeyboardKey(
         * InputConstants.KEY_RSHIFT ).buildAndRegis();
         * CONTROLLYR = new TacKeyBuilder( "key.tac.ccr" ).withKeyboardKey(
         * InputConstants.KEY_RCONTROL ).buildAndRegis();
         * ALTYR = new TacKeyBuilder("key.tac.aar" ).withKeyboardKey(
         * InputConstants.KEY_RALT ).buildAndRegis();
         * SIZE_OPT = new TacKeyBuilder( "key.tac.sizer" ).withKeyboardKey(
         * InputConstants.KEY_PERIOD ).buildAndRegis();
         * P = new TacKeyBuilder( "key.tac.p" ).withKeyboardKey( InputConstants.KEY_P
         * ).buildAndRegis();
         * L = new TacKeyBuilder( "key.tac.l" ).withKeyboardKey( InputConstants.KEY_L
         * ).buildAndRegis();
         * O = new TacKeyBuilder( "key.tac.o" ).withKeyboardKey( InputConstants.KEY_O
         * ).buildAndRegis();
         * K = new TacKeyBuilder( "key.tac.k" ).withKeyboardKey( InputConstants.KEY_K
         * ).buildAndRegis();
         * M = new TacKeyBuilder( "key.tac.m" ).withKeyboardKey( InputConstants.KEY_M
         * ).buildAndRegis();
         * I = new TacKeyBuilder( "key.tac.i" ).withKeyboardKey( InputConstants.KEY_I
         * ).buildAndRegis();
         * J = new TacKeyBuilder( "key.tac.j" ).withKeyboardKey( InputConstants.KEY_J
         * ).buildAndRegis();
         * N = new TacKeyBuilder( "key.tac.n" ).withKeyboardKey( InputConstants.KEY_N
         * ).buildAndRegis();
         * UP = new TacKeyBuilder( "key.tac.bbb" ).withKeyboardKey(
         * InputConstants.KEY_UP ).buildAndRegis();
         * RIGHT = new TacKeyBuilder( "key.tac.vvv" ).withKeyboardKey(
         * InputConstants.KEY_RIGHT ).buildAndRegis();
         * LEFT = new TacKeyBuilder( "key.tac.ccc" ).withKeyboardKey(
         * InputConstants.KEY_LEFT ).buildAndRegis();
         * DOWN = new TacKeyBuilder( "key.tac.zzz" ).withKeyboardKey(
         * InputConstants.KEY_DOWN ).buildAndRegis();
         */
    }
