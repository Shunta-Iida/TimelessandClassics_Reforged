...
public class RenderItemEvent extends Event {
    ...
    public static class Entity extends RenderItemEvent {
        ...
        /**
         * Called before the item is rendered on the ground. This event can be cancelled
         * to
         * prevent the item from being rendered and perform any custom rendering. It
         * should be noted
        ...
        /**
         * Called after the item has been rendered and if {@link Pre} has not been
         * cancelled. This
    ...
    public static class Gui extends RenderItemEvent {
        ...
        /**
         * Called before the item is rendered in the GUI. This event can be cancelled to
         * prevent the
         * item from being rendered and perform any custom rendering. It should be noted
         * that
    ...
    public static class ItemFrame extends RenderItemEvent {
        ...
        /**
         * Called before the item is rendered into the item frame. This event can be
         * cancelled to
         * prevent the item from being rendered and perform any custom rendering. It
         * should be noted
         * that cancelling this event will prevent {@link Post} from being called.
