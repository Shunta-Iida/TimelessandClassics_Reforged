...
public final class TacKeyMapping extends KeyMapping {
    ...
    public TacKeyMapping(String description, IKeyConflictContext keyConflictContext,
            KeyModifier keyModifier, Key keyCode, String category) {
    ...
    public static final class TacKeyBuilder {
        ...
        public TacKeyMapping buildAndRegis() {
            final TacKeyMapping kb = new TacKeyMapping(this.description, this.conflict_context,
                    this.modifier, this.key, "key.categories.tac");
