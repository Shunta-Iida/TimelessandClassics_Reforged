...
public class GunEnumOption<E extends Enum<E> & StringRepresentable> {
     ...
     * 
     * public GunEnumOption(String title, Class<E> enumClass, Function<Options, E>
     * getter, BiConsumer<Options, E> setter, BiFunction<Options, GunEnumOption<E>,
     * Component> displayNameGetter)
     * {
     * super(title);
     ...
     * {
     * return new OptionButton(x, y, width, 20, this, this.getTitle(options),
     * (button) -> {
