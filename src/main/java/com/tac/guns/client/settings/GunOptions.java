...
public class GunOptions {
    ...
    public static final ProgressOption X_AMMOCOUNTER_POS =
            new ProgressOption("tac.options.xAmmoCounterPos", -500, 500, 0.001F,
                    gameSettings -> Config.CLIENT.weaponGUI.weaponAmmoCounter.x.get(),
                    (gamesettings, value) -> {
                        Config.CLIENT.weaponGUI.weaponAmmoCounter.x
                                .set(Mth.clamp(value, -500, 500));
                        Config.saveClientConfig();
                    },
                    (gameSettings, option) -> new TranslatableComponent(
    ...
    public static final ProgressOption Y_AMMOCOUNTER_POS =
            new ProgressOption("tac.options.yAmmoCounterPos", -500, 500, 0.001F,
                    ...
                    (gamesettings, value) -> {
                        Config.CLIENT.weaponGUI.weaponAmmoCounter.y
                                .set(Mth.clamp(value, -500, 500));
                        Config.saveClientConfig();
                    },
                    (gameSettings, option) -> new TranslatableComponent(
    ...
    public static final ProgressOption SIZE_AMMOCOUNTER_POS = new ProgressOption(
            ...
            (gamesettings, value) -> {
                Config.CLIENT.weaponGUI.weaponAmmoCounter.weaponAmmoCounterSize
                        .set(Mth.clamp(value, 0.1, 4));
                Config.saveClientConfig();
            },
            (gameSettings, option) -> new TranslatableComponent(
    ...
    public static final ProgressOption SIZE_Icon_POS =
            new ProgressOption("tac.options.sizeIconPos", 0.1, 4, 0.001F,
                    ...
                    (gamesettings, value) -> {
                        Config.CLIENT.weaponGUI.weaponTypeIcon.weaponIconSize
                                .set(Mth.clamp(value, 0.1, 4));
                        Config.saveClientConfig();
                    },
                    (gameSettings, option) -> new TranslatableComponent(
    ...
    public static final ProgressOption X_ReloadBar_POS =
            new ProgressOption("tac.options.xReloadBarPos", -500, 500, 0.001F,
                    gameSettings -> Config.CLIENT.weaponGUI.weaponReloadTimer.x.get(),
                    (gamesettings, value) -> {
                        Config.CLIENT.weaponGUI.weaponReloadTimer.x
                                .set(Mth.clamp(value, -500, 500));
                        Config.saveClientConfig();
                    },
                    (gameSettings, option) -> new TranslatableComponent(
    ...
    public static final ProgressOption Y_ReloadBar_POS =
            new ProgressOption("tac.options.yReloadBarPos", -500, 500, 0.001F,
                    ...
                    (gamesettings, value) -> {
                        Config.CLIENT.weaponGUI.weaponReloadTimer.y
                                .set(Mth.clamp(value, -500, 500));
                        Config.saveClientConfig();
                    },
                    (gameSettings, option) -> new TranslatableComponent(
    ...
    public static final ProgressOption SIZE_ReloadBar_POS = new ProgressOption(
            ...
            (gamesettings, value) -> {
                Config.CLIENT.weaponGUI.weaponReloadTimer.weaponReloadTimerSize
                        .set(Mth.clamp(value, 0.1, 4));
                Config.saveClientConfig();
            },
            (gameSettings, option) -> new TranslatableComponent(
