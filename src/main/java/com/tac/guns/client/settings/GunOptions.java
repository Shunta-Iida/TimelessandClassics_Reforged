...
public class GunOptions {
    ...
    public static final ProgressOption ADS_SENSITIVITY = new ProgressOption("tac.options.adsSensitivity", 0.0, 1.0,
            0.01F, gameSettings -> {
    ...
    public static final CycleOption<Boolean> DOUBLE_RENDER_EXIST = CycleOption.createOnOff("tac.options.doubleRender",
            (settings) -> {
    ...
    public static final CycleOption<Boolean> HOLD_TO_AIM = CycleOption.createOnOff("tac.options.holdToAim",
            (settings) -> {
    ...
    public static final CycleOption<Boolean> ALLOW_LEVER = CycleOption.createOnOff("tac.options.allowLever",
            (settings) -> {
    ...
    public static final CycleOption<Boolean> ALLOW_BUTTON = CycleOption.createOnOff("tac.options.allowButton",
            (settings) -> {
    ...
    public static final CycleOption<Boolean> ALLOW_DOORS = CycleOption.createOnOff("tac.options.allowDoors",
            (settings) -> {
    ...
    public static final CycleOption<Boolean> ALLOW_TRAP_DOORS = CycleOption.createOnOff("tac.options.allowTrapDoors",
            (settings) -> {
    ...
    public static final CycleOption<Boolean> ALLOW_CRAFTING_TABLE = CycleOption
            .createOnOff("tac.options.allowCraftingTable", (settings) -> {
                return Config.CLIENT.rightClickUse.allowCraftingTable.get();
            }, (settings, function, value) -> {
                Config.CLIENT.rightClickUse.allowCraftingTable.set(value);
                Config.saveClientConfig();
            });
    public static final CycleOption<Boolean> ALLOW_CHESTS = CycleOption.createOnOff("tac.options.allowChests",
            (settings) -> {
    ...
    public static final CycleOption<Boolean> ALLOW_FENCE_GATES = CycleOption.createOnOff("tac.options.allowFenceGates",
            (settings) -> {
     ...
     * public static final Option CROSSHAIR = new
     * GunListOption<>("tac.options.crosshair", () -> {
     ...
     * return new TranslatableComponent(id.getNamespace() + ".crosshair." +
     * id.getPath());
     ...
     * GuiComponent.blit(matrixStack, (16 - 15) / 2, (16 - 15) / 2, 0, 0, 0, 15, 15,
     * 256, 256);
     * }
     * else
     * {
     ...
     * });
     * 
     * public static final CycleOption<Boolean> SHOW_FPS_TRAILS_EXIST =
     * CycleOption.createOnOff("tac.options.showFirstPersonBulletTrails", (settings)
     * -> {
    ...
    public static final CycleOption<Boolean> FIREMODE_EXIST = CycleOption.createOnOff("tac.options.firemodeExist",
            (settings) -> {
    ...
    public static final ProgressOption X_FIREMODE_POS = new ProgressOption("tac.options.xFiremodePos", -500, 500,
            0.001F,
            gameSettings -> {
    ...
    public static final ProgressOption Y_FIREMODE_POS = new ProgressOption("tac.options.yFiremodePos", -500, 500,
            0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.yFiremodePos.format",
                    FORMAT.format(Config.CLIENT.weaponGUI.weaponFireMode.y.get())));

    public static final ProgressOption SIZE_FIREMODE_POS = new ProgressOption("tac.options.sizeFiremodePos", 0.1, 4,
            0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.sizeFiremodePos.format",
                    FORMAT.format(Config.CLIENT.weaponGUI.weaponFireMode.weaponFireModeSize.get())));

    // AmmoCounter positioning
    public static final CycleOption<Boolean> AMMOCOUNTER_EXIST = CycleOption.createOnOff("tac.options.ammoCounterExist",
            (settings) -> {
    ...
    public static final ProgressOption X_AMMOCOUNTER_POS = new ProgressOption("tac.options.xAmmoCounterPos", -500, 500,
            0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.xAmmoCounterPos.format",
                    FORMAT.format(Config.CLIENT.weaponGUI.weaponAmmoCounter.x.get())));

    public static final ProgressOption Y_AMMOCOUNTER_POS = new ProgressOption("tac.options.yAmmoCounterPos", -500, 500,
            0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.yAmmoCounterPos.format",
                    FORMAT.format(Config.CLIENT.weaponGUI.weaponAmmoCounter.y.get())));

    public static final ProgressOption SIZE_AMMOCOUNTER_POS = new ProgressOption("tac.options.sizeAmmoCounterPos", 0.1,
            4, 0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.sizeAmmoCounterPos.format",
                    FORMAT.format(Config.CLIENT.weaponGUI.weaponAmmoCounter.weaponAmmoCounterSize.get())));

    // WeaponIcon positioning
    public static final CycleOption<Boolean> WeaponIcon_EXIST = CycleOption.createOnOff("tac.options.iconExist",
            (settings) -> {
                return Config.CLIENT.weaponGUI.weaponTypeIcon.showWeaponIcon.get();
            }, (settings, function, value) -> {
                Config.CLIENT.weaponGUI.weaponTypeIcon.showWeaponIcon.set(value);
    ...
    public static final ProgressOption SIZE_Icon_POS = new ProgressOption("tac.options.sizeIconPos", 0.1, 4, 0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.sizeIconPos.format",
                    FORMAT.format(Config.CLIENT.weaponGUI.weaponTypeIcon.weaponIconSize.get())));

    // WeaponIcon positioning
    public static final CycleOption<Boolean> ReloadBar_EXIST = CycleOption.createOnOff("tac.options.reloadBarExist",
            (settings) -> {
    ...
    public static final ProgressOption X_ReloadBar_POS = new ProgressOption("tac.options.xReloadBarPos", -500, 500,
            0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.xReloadBarPos.format",
    ...
    public static final ProgressOption Y_ReloadBar_POS = new ProgressOption("tac.options.yReloadBarPos", -500, 500,
            0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.yReloadBarPos.format",
                    FORMAT.format(Config.CLIENT.weaponGUI.weaponReloadTimer.y.get())));

    public static final ProgressOption SIZE_ReloadBar_POS = new ProgressOption("tac.options.sizeReloadBarPos", 0.1, 4,
            0.001F,
            ...
            (gameSettings, option) -> new TranslatableComponent("tac.options.sizeReloadBarPos.format",
                    FORMAT.format(Config.CLIENT.weaponGUI.weaponReloadTimer.weaponReloadTimerSize.get())));
