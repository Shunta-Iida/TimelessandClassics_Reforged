    ...
    public void render(float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack,
        ...
        if (transformType.firstPerson() && entity.equals(Minecraft.getInstance().player)) {
            ...
            matrixStack.pushPose();
            {
                ...
                matrixStack
                        .translate((-size / 2) + scopeData.getDrXZoomMod(),
                                (0.0685075 + 0.01175 - 0.003) + scopeData.getDrYZoomMod(),
                                (Config.CLIENT.display.scopeDoubleRender
                                        .get() ? (4.65 + 0.52975 - 0.618 - 2.8744 + scopeData.getDrZZoomMod()) * 0.0625
                                                : (4.65 + 0.52975 - 0.618 - 2.8744 + scopeData.getDrZZoomMod())
                                                        * 0.0625/*
                ...
                matrixStack.translate((-0.00327715 - 0.0063525 + 0.000215 + 0.00877625) + scopeData.getReticleXMod(),
                        (-0.003385 - 0.00847125 + 0.0008 + 0.01049125) + scopeData.getReticleYMod(),
                        (Config.CLIENT.display.scopeDoubleRender.get() ? (0.002) + scopeData.getReticleZMod()
                ...
                matrixStack.mulPose(Vector3f.YN.rotationDegrees(
                        (GunRenderingHandler.get().newSwayYaw * GunRenderingHandler.get().recoilReduction) * 0.082F));
                matrixStack.mulPose(Vector3f.ZN.rotationDegrees(
                        (GunRenderingHandler.get().newSwayYaw * GunRenderingHandler.get().weaponsHorizontalAngle * 0.65f
                ...
                matrixStack.mulPose(Vector3f.XP.rotationDegrees(
                        (GunRenderingHandler.get().recoilLift * GunRenderingHandler.get().recoilReduction) * 0.041F));
                matrixStack.translate(0, 0, 0.35);
