...
public class tec_9_animation extends SkinnedGunModel {
    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                TEC9AnimationController.INDEX_BODY, transformType, matrices);
        ...
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                TEC9AnimationController.INDEX_MAG, transformType, matrices);
        ...
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                TEC9AnimationController.INDEX_BOLT, transformType, matrices);
        ...
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                TEC9AnimationController.INDEX_BULLET, transformType, matrices);
