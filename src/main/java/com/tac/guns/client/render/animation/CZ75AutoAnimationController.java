...
public class CZ75AutoAnimationController extends PistalAnimationController {
    ...
    public static final AnimationMeta RELOAD_NORM = new AnimationMeta(
            new ResourceLocation("tac", "animations/cz75_auto_reload_norm.gltf"));
    public static final AnimationMeta DRAW = new AnimationMeta(
            new ResourceLocation("tac", "animations/cz75_auto_draw.gltf"));
    ...
    public static final AnimationMeta INSPECT = new AnimationMeta(
            new ResourceLocation("tac", "animations/cz75_auto_inspect.gltf"));
    ...
    public static final AnimationMeta STATIC = new AnimationMeta(
            new ResourceLocation("tac", "animations/cz75_auto_static.gltf"));
