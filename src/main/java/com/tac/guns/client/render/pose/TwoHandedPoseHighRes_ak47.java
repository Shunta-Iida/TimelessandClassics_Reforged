...
public class TwoHandedPoseHighRes_ak47 extends TwoHandedPose {
    ...
    public void renderFirstPersonArms(final LocalPlayer player, final HumanoidArm hand,
        ...
        // stack);
        // extraMatrixStack.translate(reloadProgress * 1.25, -reloadProgress,
        // -reloadProgress * 1.5);
        ...
        final double translationSide = hand.getOpposite() == HumanoidArm.RIGHT ? -1 : -1;
 ...
 * 
 * @Override
 * public void renderFirstPersonArms(ClientPlayerEntity player, HandSide hand,
 * ItemStack stack, MatrixStack matrixStack, IRenderTypeBuffer buffer, int
 * light, float partialTicks) {
 * 
 * matrixStack.push();
 * GunAnimationController controller =
 * GunAnimationController.fromItem(stack.getItem());
 * if(controller != null) controller.applyLeftHandTransform(stack, player,
 * matrixStack);
 * matrixStack.translate(0, 0, -1);
