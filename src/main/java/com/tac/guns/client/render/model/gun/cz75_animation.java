    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    CZ75AnimationController.INDEX_BODY, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    CZ75AnimationController.INDEX_MAG, transformType, matrices);
        ...
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                CZ75AnimationController.INDEX_SLIDE, transformType, matrices);
            ...
            if (transformType.firstPerson()) {
                ...
                if (Gun.hasAmmo(stack) || shouldOffset) {
                    ...
                    matrices.translate(0, 0,
                            0.2075f * (-4.5 * Math.pow(cooldownOg - 0.5, 2) + 1.0));
