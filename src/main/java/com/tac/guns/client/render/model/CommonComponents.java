...
public class CommonComponents {
    ...
    public static final GunComponent BOLT_TAIL = new GunComponent("bolt_tail"); // the block behind a bolt; usually on
                                                                                // RFs
    ...
    // handle
    public static final GunComponent HANDLE = new GunComponent("handle"); // the handle behind a gun; like m4 or mk47 or
                                                                          // udp etc. or the handle to lift
    ...
    public static final GunComponent MUZZLE_DEFAULT = new GunComponent("muzzle_default"); // default muzzle; render if
                                                                                          // there is no muzzle
                                                                                          // attachment
    ...
    // rail
    public static final GunComponent GRIP_RAIL_COVER = new GunComponent("grip_rail_cover"); // the cover on rail when
                                                                                            // there are no attachments
                                                                                            // on the under rail
    public static final GunComponent SIDE_RAIL_COVER = new GunComponent("side_rail_cover"); // the cover on rail when
                                                                                            // there are no attachments
                                                                                            // on the side rail
    public static final GunComponent TOP_RAIL_COVER = new GunComponent("top_rail_cover"); // the cover on rail when
                                                                                          // there are no attachments on
                                                                                          // the top rail
    public static final GunComponent HAND_GUARD_DEFAULT = new GunComponent("hand_guard_default"); // default rail
    public static final GunComponent HAND_GUARD_EXTENDED = new GunComponent("hand_guard_extended"); // an extended on
                                                                                                    // rail for rail
                                                                                                    // attachments
    public static final GunComponent RAIL_EXTENDED_UNDER = new GunComponent("rail_extended_under"); // an extended on
                                                                                                    // rail for
                                                                                                    // under-rail
                                                                                                    // attachments
    public static final GunComponent RAIL_EXTENDED_SIDE = new GunComponent("rail_extended_side"); // an extended on rail
                                                                                                  // for side-rail
                                                                                                  // attachments
    public static final GunComponent RAIL_EXTENDED_TOP = new GunComponent("rail_extended_top"); // an extended on rail
                                                                                                // for top-rail
                                                                                                // attachments
    public static final GunComponent RAIL_SCOPE = new GunComponent("rail_scope"); // the rail for place the scope (like
                                                                                  // mount of ak47)

    // sight
    public static final GunComponent SIGHT = new GunComponent("sight"); // iron sight( For pistols, usually refers to
                                                                        // the part near the muzzle that does not move
                                                                        // with the slide)
    public static final GunComponent SIGHT_LIGHT = new GunComponent("sight_light"); // light part of the iron sight
    public static final GunComponent SIGHT_FOLDED = new GunComponent("sight_folded"); // folded sight, render when
                                                                                      // install a scope
    public static final GunComponent SIGHT_FOLDED_LIGHT = new GunComponent("sight_folded_light"); // light part of
                                                                                                  // folded sight
    ...
    // stock
    public static final GunComponent STOCK_DEFAULT = new GunComponent("stock_default"); // default stock; render if
                                                                                        // there is no stock attachment
