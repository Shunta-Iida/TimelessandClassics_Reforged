 ...
 *
 * "key" is used to identify a component model. It appears in the file name in
 * suffix form.
 * For example, ak47_stock_light.json is a model file that contain the light
 * stock of the ak47. Its corresponding component key is "stock_light".
 *
 * "namespace" is used to distinguish GunComponents under different
 * organizations.
 * If two GunComponent with the same key have different namespaces, they are not
