...
public class m92fs_animation extends SkinnedGunModel {
    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), M92FSAnimationController.INDEX_BODY,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), M92FSAnimationController.INDEX_MAG,
                    transformType, matrices);
        ...
        // Always push
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY), M92FSAnimationController.INDEX_SLIDE,
                transformType, matrices);
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), M92FSAnimationController.INDEX_BULLET,
                    transformType, matrices);
