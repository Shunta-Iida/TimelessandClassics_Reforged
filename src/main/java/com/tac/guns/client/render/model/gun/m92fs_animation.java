    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M92FSAnimationController.INDEX_BODY, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M92FSAnimationController.INDEX_MAG, transformType, matrices);
        ...
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                M92FSAnimationController.INDEX_SLIDE, transformType, matrices);
        if (transformType.firstPerson()) {
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M92FSAnimationController.INDEX_BULLET, transformType, matrices);
