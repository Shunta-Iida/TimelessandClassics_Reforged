    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    Ak47AnimationController.INDEX_BODY, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    Ak47AnimationController.INDEX_BOLT, transformType, matrices);
            ...
            if (transformType.firstPerson()) {
                ...
                GunRenderingHandler.get().opticMovement =
                        0.190f * (-4.5 * Math.pow(cooldownOg - 0.5, 2) + 1);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    Ak47AnimationController.INDEX_MAGAZINE, transformType, matrices);
