...
/**
 * A simple interface to render custom models. This can only be used for
 * overriding the models of
 * guns or attachments.
 */
public interface IOverrideModel {
     ...
     * @param parent        if an attachment, the parent is the weapon this
     *                      attachment is attached to otherwise it's an empty stack.
