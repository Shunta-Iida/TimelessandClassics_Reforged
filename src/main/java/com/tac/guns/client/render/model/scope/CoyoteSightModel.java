...
public class CoyoteSightModel implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemTransforms.TransformType transformType,
         ...
         * }
         */
        int bodyColor = RenderUtil.getItemStackColor(stack, parent,
                IAttachmentItem.Type.SCOPE_BODY_COLOR, 0);
        ...
        if (transformType.firstPerson() && entity.equals(Minecraft.getInstance().player)) {
            ScopeData scopeData = ScopeEditor.get().getScopeData() == null
                    || ScopeEditor.get().getScopeData().getTagName() != "coyote" ? new ScopeData("")
            ...
            matrixStack.pushPose();
            {
                ...
                matrixStack.translate(((-size / 2) - 0.0035 + scopeData.getReticleXMod()),
                        (0.85 - 0.164 + scopeData.getReticleYMod()) * 0.0625,
                        (0.395 + 0.5995 + scopeData.getReticleZMod()) * 0.0625);
