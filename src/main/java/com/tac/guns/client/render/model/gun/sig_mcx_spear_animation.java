    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    SIGMCXAnimationController.INDEX_BODY, transformType, matrices);
                ...
                if (transformType.firstPerson()) {
                    ...
                    if (Gun.hasAmmo(stack)) {
                        ...
                        matrices.translate(0, 0,
                                0.225f * (-4.5 * Math.pow(cooldownOg - 0.5, 2) + 1.0));
        ...
        matrices.pushPose();
        {
            ...
            RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.HANDLE_EXTRA), stack,
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    SIGMCXAnimationController.INDEX_MAG, transformType, matrices);
