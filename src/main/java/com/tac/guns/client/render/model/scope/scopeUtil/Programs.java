...
public class Programs {
    ...
    public static void init() {
        ...
        GL20.glShaderSource(normalvshader, "#version 120\r\n" + "varying vec4 color;\r\n"
        ...
        GL20.glShaderSource(depthvshader, "#version 120\r\n" + "varying vec4 color;\r\n"
                + "varying vec2 texcoord;\r\n" + "\r\n" + "void main()\r\n" + "{\r\n"
                + "    texcoord = (gl_TextureMatrix[0] * gl_MultiTexCoord0).st;\r\n"
                + "    color = gl_Color;\r\n"
                + "    gl_Position = gl_ProjectionMatrix  * gl_ModelViewMatrix * gl_Vertex;" + "}");
        ...
        GL20.glShaderSource(overlayvshader, "#version 120\r\n" + "varying vec4 color;\r\n"
                + "varying vec2 texcoord;\r\n" + "\r\n" + "void main()\r\n" + "{\r\n"
                + "    texcoord = (gl_TextureMatrix[0] * gl_MultiTexCoord0).st;\r\n"
                + "    color = gl_Color;\r\n"
                + "    gl_Position = gl_ProjectionMatrix  * gl_ModelViewMatrix * gl_Vertex;" + "}");
        ...
        GL20.glShaderSource(overlayfshader, "#version 120\r\n" + "\r\n"
        ...
        GL20.glShaderSource(scopeBorderShader_V, "#version 120\r\n" + "varying vec4 color;\r\n"
                + "varying vec2 texcoord;\r\n" + "\r\n" + "void main()\r\n" + "{\r\n"
                + "    texcoord = (gl_TextureMatrix[0] * gl_MultiTexCoord0).st;\r\n"
                + "    color = gl_Color;\r\n"
                + "    gl_Position = gl_ProjectionMatrix  * gl_ModelViewMatrix * gl_Vertex;" + "}");
        ...
        GL20.glShaderSource(scopeBorderShader_F, "#version 120\r\n"
                + "uniform sampler2D texture;\r\n" + "uniform vec2 size;\r\n"
                + "varying vec2 texcoord;\r\n" + "varying vec4 color;\r\n"
        ...
        GL20.glShaderSource(sunglassesvshader, "#version 120\r\n" + "varying vec4 color;\r\n"
                + "varying vec2 texcoord;\r\n" + "\r\n" + "void main()\r\n" + "{\r\n"
                + "    texcoord = (gl_TextureMatrix[0] * gl_MultiTexCoord0).st;\r\n"
                + "    color = gl_Color;\r\n"
                + "    gl_Position = gl_ProjectionMatrix  * gl_ModelViewMatrix * gl_Vertex;" + "}");
        ...
        GL20.glShaderSource(alphaDepthvshader, "#version 120\r\n" + "varying vec4 color;\r\n"
                + "varying vec2 texcoord;\r\n" + "\r\n" + "void main()\r\n" + "{\r\n"
                + "    texcoord = (gl_TextureMatrix[0] * gl_MultiTexCoord0).st;\r\n"
                + "    color = gl_Color;\r\n"
                + "    gl_Position = gl_ProjectionMatrix  * gl_ModelViewMatrix * gl_Vertex;" + "}");
