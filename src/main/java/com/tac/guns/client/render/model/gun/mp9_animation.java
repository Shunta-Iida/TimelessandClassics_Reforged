    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    MP9AnimationController.INDEX_BODY, transformType, matrices);
            ...
            if (Gun.getScope(stack) != null) {
                if (Objects.equals(GunModifierHelper.getAdditionalSkin(stack), "THUNDER"))
                    RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.LIGHT), stack,
            ...
            if (Objects.equals(GunModifierHelper.getAdditionalSkin(stack), "THUNDER")) {
                ...
                if (stack.getTag().getInt("CurrentFireMode") == 1) {
                    ...
                    RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.SAFETY), stack,
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    MP9AnimationController.INDEX_MAGAZINE, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    MP9AnimationController.INDEX_HANDLE, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    MP9AnimationController.INDEX_BULLET, transformType, matrices);
