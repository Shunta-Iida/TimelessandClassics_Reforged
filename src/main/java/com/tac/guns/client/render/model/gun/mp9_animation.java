...
public class mp9_animation extends SkinnedGunModel {
    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), MP9AnimationController.INDEX_BODY,
            ...
            if (Gun.getScope(stack) != null) {
                if (Objects.equals(GunModifierHelper.getAdditionalSkin(stack), "THUNDER"))
                    RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.LIGHT), stack, matrices,
            ...
            if (Objects.equals(GunModifierHelper.getAdditionalSkin(stack), "THUNDER")) {
                ...
                if (stack.getTag().getInt("CurrentFireMode") == 1) {
                    ...
                    RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.SAFETY), stack, matrices,
                            renderBuffer, light, overlay);
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), MP9AnimationController.INDEX_MAGAZINE,
                    transformType, matrices);
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), MP9AnimationController.INDEX_HANDLE,
                    transformType, matrices);
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), MP9AnimationController.INDEX_BULLET,
                    transformType, matrices);
