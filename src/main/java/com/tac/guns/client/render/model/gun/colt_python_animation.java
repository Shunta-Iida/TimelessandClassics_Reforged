...
public class colt_python_animation extends SkinnedGunModel {
    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack,
        ...
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY), COLTPYTHONAnimationController.INDEX_BODY,
        ...
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY), COLTPYTHONAnimationController.INDEX_MAG,
                transformType, matrices);
        ...
        RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.HAMMER), stack, matrices, renderBuffer, light,
                overlay);
        matrices.popPose();
        ...
        RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.ROTATE), stack, matrices, renderBuffer, light,
                overlay);
        matrices.popPose();
        ...
        if ((controller.getAnimationFromLabel(GunAnimationController.AnimationLabel.RELOAD_NORMAL)
            ...
            RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.LOADER), stack, matrices, renderBuffer,
                    light, overlay);
        }
        matrices.popPose();
