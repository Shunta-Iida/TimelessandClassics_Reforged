...
public class TacGunComponents {
    ...
    // barrel
    public static final GunComponent BARREL = new GunComponent("tac", "barrel"); // out length barrel for adjust the
                                                                                 // position
    ...
    public static final GunComponent STOCK_FOLDED = new GunComponent("tac", "stock_folded"); // default folded stock;
