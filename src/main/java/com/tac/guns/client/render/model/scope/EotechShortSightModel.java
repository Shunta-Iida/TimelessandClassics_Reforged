...
public class EotechShortSightModel implements IOverrideModel {
    private static final ResourceLocation RED_DOT_RETICLE = new ResourceLocation(Reference.MOD_ID,
            "textures/items/timeless_scopes/eotech_cqb_reticle.png");
    ...
    public void render(float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack,
        ...
        if (transformType.firstPerson() && entity.equals(Minecraft.getInstance().player)) {
            ...
            matrixStack.pushPose();
            {
                ...
                alpha = AimingHandler.get().getNormalisedAdsProgress() != 0
                        && AimingHandler.get().getNormalisedAdsProgress() != 1
                                ? (float) (0.5F * AimingHandler.get().getNormalisedAdsProgress())
                 ...
                 * GunRenderingHandler.get().applyJumpingTransforms(matrixStack,
                 * partialTicks,-0.8f);
                 * 
                 * matrixStack.translate(0, 0, -0.35);
                 * matrixStack.rotate(Vector3f.YP.rotationDegrees(GunRenderingHandler.get().
                 * newSwayYaw*0.5f));
