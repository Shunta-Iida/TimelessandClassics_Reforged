    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    MK23AnimationController.INDEX_BODY, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    MK23AnimationController.INDEX_MAG, transformType, matrices);
        ...
        matrices.pushPose();
        controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                MK23AnimationController.INDEX_SLIDE, transformType, matrices);
        if (transformType.firstPerson()) {
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    MK23AnimationController.INDEX_BULLET, transformType, matrices);
