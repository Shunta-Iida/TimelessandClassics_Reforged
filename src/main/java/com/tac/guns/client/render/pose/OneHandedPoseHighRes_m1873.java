 ...
 * 
 * Much of this entire file is from the Original One Handed Pose from the CGM
 * mod, and is only slightly modified in some very specific values, the one
 * comment is the only part I have changed
 */
public class OneHandedPoseHighRes_m1873 extends OneHandedPose {
    ...
    public void renderFirstPersonArms(LocalPlayer player, HumanoidArm hand, ItemStack stack,
        ...
        /*
         * For changing the single hand Pose animation ( Where will the hand be
         * rendered, used to display the hand / hands on screen in a certain location,
         * matching the current held gun)
         * We would need to change the location of our hand by adjusting the values of
         * [x,y,z](1), changing the final rotation of the rendered hand(2), and changing
         * the scale of the rendered hand (3).
         */
        ...
        RenderUtil.renderFirstPersonArm(player, hand, matrixStack, buffer, light); // Finally render our hand with the
                                                                                   // params we've set
    }
}
