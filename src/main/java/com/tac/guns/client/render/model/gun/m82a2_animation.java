    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        double v1 = -4.5 * Math.pow(cooldownOg - 0.5, 2) + 1.0;
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M82A2AnimationController.INDEX_BODY, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M82A2AnimationController.INDEX_BOLT, transformType, matrices);
            if (transformType.firstPerson()) {
                matrices.translate(0, 0, 0.375f * v1);
                matrices.translate(0, 0, 0.025F);
            }
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M82A2AnimationController.INDEX_BULLET, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M82A2AnimationController.INDEX_HANDLE, transformType, matrices);
