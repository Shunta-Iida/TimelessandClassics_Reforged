...
public abstract class ArmorBase extends Model {
    ...
    @OnlyIn(Dist.CLIENT)
    @Override
    public void renderToBuffer(PoseStack matrixStack, VertexConsumer builder, int p_225598_3_,
            int p_225598_4_, float p_225598_5_, float p_225598_6_, float p_225598_7_,
            float p_225598_8_) {
        this.getModel().render(matrixStack, builder, p_225598_3_, OverlayTexture.NO_OVERLAY,
