    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M249AnimationController.INDEX_BODY, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M249AnimationController.INDEX_MAGAZINE, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M249AnimationController.INDEX_CAPS, transformType, matrices);
            RenderUtil.renderModel(getComponentModel(skin, CAP), stack, matrices, renderBuffer,
                    light, overlay);
        }
        matrices.popPose();
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M249AnimationController.INDEX_HANDLE, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M249AnimationController.INDEX_CHAIN, transformType, matrices);
            if (controller.isAnimationRunning(GunAnimationController.AnimationLabel.RELOAD_EMPTY)
                    || Gun.hasAmmo(stack)) {
                RenderUtil.renderModel(getComponentModel(skin, BULLET_CHAIN), stack, matrices,
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M249AnimationController.INDEX_ROTATE, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M249AnimationController.INDEX_IRON, transformType, matrices);
            RenderUtil.renderModel(getComponentModel(skin, TacGunComponents.BULLET_CHAIN_COVER),
