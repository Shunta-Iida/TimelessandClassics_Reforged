...
public class m870_classic_animation extends SkinnedGunModel {
    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType, ItemStack stack,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), M870AnimationController.INDEX_BODY,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), M870AnimationController.INDEX_PUMP,
                    transformType, matrices);
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY), M870AnimationController.INDEX_BULLET,
                    transformType, matrices);
        ...
        matrices.pushPose();
        {
            ...
            if (GunModifierHelper.getAmmoCapacityWeight(stack) > -1) {
                RenderUtil.renderModel(getComponentModel(skin, MAG_EXTENDED), stack, matrices, renderBuffer, light,
                        overlay);
            }
        }
        matrices.popPose();
