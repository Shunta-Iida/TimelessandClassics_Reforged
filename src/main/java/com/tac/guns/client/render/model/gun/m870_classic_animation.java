...
import static com.tac.guns.client.render.model.CommonComponents.PUMP;
    ...
    public void render(GunSkin skin, float partialTicks, ItemTransforms.TransformType transformType,
        ...
        matrices.pushPose();
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M870AnimationController.INDEX_BODY, transformType, matrices);
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M870AnimationController.INDEX_PUMP, transformType, matrices);
            RenderUtil.renderModel(getComponentModel(skin, PUMP), stack, matrices, renderBuffer,
                    light, overlay);
        }
        matrices.popPose();
        ...
        {
            controller.applySpecialModelTransform(getComponentModel(skin, BODY),
                    M870AnimationController.INDEX_BULLET, transformType, matrices);
        ...
        matrices.pushPose();
        {
            ...
            if (GunItemHelper.of(stack).getAmmoCapacityWeight() > -1) {
                RenderUtil.renderModel(getComponentModel(skin, MAG_EXTENDED), stack, matrices,
                        renderBuffer, light, overlay);
            }
        }
        matrices.popPose();
