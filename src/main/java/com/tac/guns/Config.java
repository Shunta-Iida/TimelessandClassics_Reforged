...
public class Config {
        ...
        public static class Sounds {
                ...
                public Sounds(ForgeConfigSpec.Builder builder) {
                        builder.comment("Control sounds triggered by guns").push("sounds");
                        {
                                ...
                                this.headshotSound = builder.comment("The sound to play when a headshot occurs").define(
                                                "headshotSound",
                                ...
                                this.criticalSound = builder.comment("The sound to play when a critical occurs").define(
                                                "criticalSound",
                                                "minecraft:entity.player.attack.crit");
                        }
                        builder.pop();
        ...
        public static class Display {
                ...
                public Display(ForgeConfigSpec.Builder builder) {
                        builder.comment("Configuration for display related options").push("display");
                        {
                                ...
                                this.weaponDelayedSwayYNOptical = builder
                                                .comment("If true, the weapon will drag against the aiming point ONLY if an optic is added.")
        ...
        public static class RightClickUse {
                ...
                public RightClickUse(ForgeConfigSpec.Builder builder) {
                        builder.comment("Control what can interact with when holding gun in hand.")
                                        .push("rightClickUses");
                        {
                                this.allowChests = builder.comment("Whether allow chest use").define("allowChests",
                                                false);
                                this.allowLever = builder.comment("Whether allow lever use").define("allowLever", true);
                                this.allowButton = builder.comment("Whether allow button use").define("allowButton",
                                                true);
                                ...
                                this.allowFenceGates = builder.comment("Whether allow fence gates use").define(
                                                "allowFenceGates",
                                                false);
        ...
        public static class WeaponTypeIcon {
                ...
                public WeaponTypeIcon(ForgeConfigSpec.Builder builder) {
                        builder.comment("Configuration for HUD additions").push("weaponTypeIcon");
                        {
                                ...
                                this.x = builder.comment("X Position on your HUD.").defineInRange("XLocation", 0, -500d,
                                                500d);
                                this.y = builder.comment("Y Position on your HUD.").defineInRange("YLocation", 0, -500d,
                                                500d);
                        }
                        builder.pop();
                }
        ...
        public static class WeaponAmmoCounter {
                ...
                public WeaponAmmoCounter(ForgeConfigSpec.Builder builder) {
                        ...
                        {
                                this.showWeaponAmmoCounter = builder
                                                .comment("Display the amount of ammunition your weapon holds and can hold on your HUD.")
                                                .define("showWeaponAmmoCounter", true);
                                this.weaponAmmoCounterSize = builder
                                                .comment("Size of the weapon ammunition counter on your HUD")
        ...
        public static class WeaponFireMode {
                ...
                public WeaponFireMode(ForgeConfigSpec.Builder builder) {
                        ...
                        {
                                this.showWeaponFireMode = builder.comment("Display the weapon's fire mode on your HUD.")
                                                .define("showWeaponFireMode", true);
                                this.weaponFireModeSize = builder.comment("Size of the weapon's fire mode on your HUD")
        ...
        public static class WeaponReloadTimer {
                ...
                public WeaponReloadTimer(ForgeConfigSpec.Builder builder) {
                        ...
                        {
                                this.showWeaponReloadTimer = builder
                                                .comment("Display the amount of ammunition your weapon holds and can hold on your HUD.")
                                                .define("showWeaponAmmoCounter", true);
                                this.weaponReloadTimerSize = builder
                                                .comment("Size of the weapon ammunition counter on your HUD")
                                                .defineInRange("weaponAmmoCounterSize", 1.0, 0.01, 4.0);
        ...
        public static class Particle {
                ...
                public Particle(ForgeConfigSpec.Builder builder) {
                        builder.comment("Properties relating to particles").push("particle");
                        {
                                ...
                                this.enableBlood = builder
                                                .comment("If true, blood will will spawn from entities that are hit from a projectile")
        ...
        public static class Controls {
                ...
                public Controls(ForgeConfigSpec.Builder builder) {
                        builder.comment("Properties relating to controls").push("controls");
                        {
                                ...
                                this.burstPress = builder
                                                .comment("Press to use a burst fire a gun, if false, burst will become semi shoot")
        ...
        public static class Gameplay {
                ...
                public Gameplay(ForgeConfigSpec.Builder builder) {
                        ...
                        {
                                this.enableGunGriefing = builder
                                                .comment("If enable, allows guns to shoot out glass and remove blocks on explosions")
                                ...
                                this.headShotDamageMultiplier = builder
                                                .comment("The value to multiply the damage by if projectile hit the players head")
                                                .defineInRange("headShotDamageMultiplier", 2.0, 1.0, Double.MAX_VALUE);
                                this.criticalDamageMultiplier = builder
                                                .comment("The value to multiply the damage by if projectile is a critical hit")
                                                .defineInRange("criticalDamageMultiplier", 2.0, 1.0, Double.MAX_VALUE);
                                this.ignoreLeaves = builder
                                                .comment("If true, projectiles will ignore leaves when checking for collision")
                                ...
                                this.realisticLowPowerFovHandling = builder
                                                .comment("Optics with 0 fov modification will not affect the players fov at all")
                                                .define("realisticLowPowerFovHandling", false);
                                this.realisticIronSightFovHandling = builder
                                                .comment("Iron sights fov modification will not affect the players fov at all")
                                ...
                                this.bulletsIgnoreStandardArmor = builder
                                                .comment("Bullets completely ignore Minecraft armor, forcing you to use our armor system.")
                                ...
                                this.glassDrop = builder.comment(
        ...
        public static class Development {
                ...
                public Development(ForgeConfigSpec.Builder builder) {
                        ...
                        {
                                this.permanentCrosshair = builder
                                                .comment("If enabled any crosshair will continue to render on aim.")
        ...
        public static class AggroMobs {
                ...
                public AggroMobs(ForgeConfigSpec.Builder builder) {
                        builder.comment("Properties relating to mob aggression").push("aggro_mobs");
                        {
                                ...
                                this.exemptEntities = builder.comment("Any mobs of defined will not aggro on shooters")
                ...
                public Missiles(ForgeConfigSpec.Builder builder) {
                        builder.comment("Properties relating to missiles").push("missiles");
                        {
                                this.explosionRadius = builder
                                                .comment("The max distance which the explosion is effective to")
        ...
        public static class Deafen {
                ...
                public Deafen(ForgeConfigSpec.Builder builder) {
                        builder.comment("Deafening properties of stun grenades").push("deafen");
                        {
                                ...
                                this.panicMobs = builder
                                                .comment("If true, peaceful mobs will panic upon being deafened by a stun grenade.")
        ...
        public static class EffectCriteria {
                ...
                public EffectCriteria(ForgeConfigSpec.Builder builder, double radius, int durationMax, int durationMin,
                                double angleEffect, double angleAttenuationMax, boolean raytraceOpaqueBlocks) {
        ...
        public static class Server {
                ...
                public Server(ForgeConfigSpec.Builder builder) {
                        builder.push("server");
                        {
                                ...
                                {
                                        this.gunShotMaxDistance = builder.comment(
                                                        "The maximum distance weapons can be heard by players.")
                                                        .defineInRange("gunShotMaxDistance", 100, 0, Double.MAX_VALUE);
                                        this.reloadingSoundDistance = builder
                                                        .comment("The maximum distance reloading a weapon can be heard by players.")
                                                        .defineInRange("reloadingSoundDistance", 14, 0,
                                                                        Double.MAX_VALUE);
                                }
                                builder.pop();

                                this.enableCameraRecoil = builder
                                                .comment("If true, enables camera recoil when firing a weapon")
