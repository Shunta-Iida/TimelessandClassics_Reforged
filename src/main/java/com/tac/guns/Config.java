...
public class Config {
    /**
     * Client related config options, Original by Mr.Crayfish, extra config options
     * added by ClumsyAlien
     */
    ...
    public static class Sounds {
        ...
        public Sounds(final ForgeConfigSpec.Builder builder) {
            builder.comment("Control sounds triggered by guns").push("sounds");
            {
                this.weaponsVolume = builder.comment(
                        "Show your ammunition as numbers, reloading timer, weapon icon, and fire mode all on the HUD.")
                        .defineInRange("weaponsVolume", 1.0, 0.0, 1.0);

                this.playSoundWhenHeadshot = builder.comment(
    ...
    public static class Display {
        ...
        public Display(final ForgeConfigSpec.Builder builder) {
            builder.comment("Configuration for display related options").push("display");
            {
                ...
                this.crosshair = builder.comment(
                        ...
                        .define("crosshair", Crosshair.DEFAULT.getLocation().toString());

                this.weaponAmmoBar = builder.comment(
                        ...
                        .define("weaponAmmoBar", false);

                this.gameplayEnchancedScopeOffset = builder.comment(
                        "Scopes are brought closer to the shooter to help fill FOV with a scope view at all times")
                        .define("gameplayEnchancedScopeOffset", true);
                this.scopeDoubleRender = builder.comment(
                        "Enable picture in picture rendering for scopes, saves on some performance and issues with Optifine")
                        .define("scopeDoubleRender", false);
                this.redDotSquishUpdate = builder.comment(
                        "Enable 0 fov multiplied sights (Dot/Holo sights) to render in 2d when aimed like the scopeDoubleRender(false) effect.")
                        .define("redDotSquishUpdate", false);
                this.sight1xRealisticPosition = builder.comment(
                        ...
                        .define("sight1xRealisticPostion", false);

                this.cameraShakeOnHit = builder.comment(
                        ...
                        .defineInRange("cameraShakeOnHit", 6, 0, 10);
                this.cameraShakeOptionGlobal = builder.comment(
                        ...
                        .define("cameraShakeOptionGlobal", false);
                this.cameraShakeOnFire = builder.comment(
                        ...
                        .define("cameraShakeOnFire", true);

                this.showFirstPersonBulletTrails = builder.comment(
                        ...
                        .define("showFirstPersonBulletTrails", true);

                this.weaponDelayedSway = builder.comment(
                        "When looking around the weapon sways smoothly in delay with the camera movement. Disable if distracting with scopes.")
                        .define("weaponDelayedSway", true);

                this.weaponDelayedSwayMaximum = builder
                        .comment("Maximum degrees the weapon's delayed sway can rotate the weapon.")
                        .defineInRange("weaponDelayedSwayMaximum", 3.35, 0.5, 10.0);
                this.weaponDelayedSwayMultiplier = builder.comment(
                        "Adjusts the sensitivity of the weapon's delayed sway, depending on mouse / head, movement.")
                        .defineInRange("weaponDelayedSwayMultiplier", -0.1, -0.4, -0.05);
                this.weaponDelayedSwayDirection = builder.comment(
                        "If true, the weapon will drag against the aiming point, false will drag the aiming point on sway.")
                        .define("weaponDelayedSwayDirection", false);
                this.weaponDelayedSwayYNOptical = builder.comment(
                        "If true, the weapon will drag against the aiming point ONLY if an optic is added.")
                        .define("weaponDelayedSwayYNOptical", false);

                this.showBulletTrails = builder.comment(
                        "Choose to see any bullet trails, trails by you or any other player / bot will not appear. Helps with Shader compatability.")
                        .define("showBulletTrails", true);
                this.bulletTrailOpacity = builder.comment(
                ...
                this.showHitMarkers = builder.comment(
    ...
    public static class WeaponGUI {
        ...
        public final WeaponAmmoInspectText weaponAmmoInspectText;

        public WeaponGUI(final ForgeConfigSpec.Builder builder) {
            builder.comment("Configuration for HUD additions").push("weaponGui");
            {
                this.weaponGui = builder.comment(
                        "Show your ammunition as numbers, reloading timer, weapon icon, and fire mode all on the HUD.")
                        .define("weaponGui", true);
                ...
                this.weaponAmmoInspectText = new WeaponAmmoInspectText(builder);
            }
            builder.pop();
        }
    }
    ...
    public static class RightClickUse {
        ...
        public RightClickUse(final ForgeConfigSpec.Builder builder) {
            builder.comment("Control what can interact with when holding gun in hand.")
                    .push("rightClickUses");
            {
                this.allowChests =
                        builder.comment("Whether allow chest use").define("allowChests", false);
                this.allowLever =
                        builder.comment("Whether allow lever use").define("allowLever", true);
                this.allowButton =
                        builder.comment("Whether allow button use").define("allowButton", true);
                this.allowDoors =
                        builder.comment("Whether allow door use").define("allowDoors", false);
                this.allowTrapDoors = builder.comment("Whether allow trap door use")
                        .define("allowTrapDoors", false);
                this.allowCraftingTable = builder.comment("Whether allow crafting table use")
                        .define("allowCraftingTable", false);
                this.allowFenceGates = builder.comment("Whether allow fence gates use")
                        .define("allowFenceGates", false);
                this.allowRestUse = builder.comment("Whether allow to interact with rest stuffs.")
                        .define("allowRestUse", false);
            }
            builder.pop();
        }
    }
    ...
    public static class WeaponTypeIcon {
        ...
        public WeaponTypeIcon(final ForgeConfigSpec.Builder builder) {
            builder.comment("Configuration for HUD additions").push("weaponTypeIcon");
            {
                this.showWeaponIcon = builder.comment("Display the weapon type Icon on your HUD.")
                        .define("showWeaponIcon", true);
                this.weaponIconSize = builder.comment("Size of the weapon type Icon on your HUD")
                        .defineInRange("weaponIconSize", 1.0, 0.01, 4.0);

                this.x = builder.comment("X Position on your HUD.").defineInRange("XLocation", 0,
                        -500d, 500d);
                this.y = builder.comment("Y Position on your HUD.").defineInRange("YLocation", 0,
                        -500d, 500d);
            }
            builder.pop();
        }
    ...
    public static class WeaponAmmoCounter {
        ...
        public WeaponAmmoCounter(final ForgeConfigSpec.Builder builder) {
            builder.comment("Configuration for HUD additions").push("weaponAmmoCounter");
            {
                this.showWeaponAmmoCounter = builder.comment(
                        "Display the amount of ammunition your weapon holds and can hold on your HUD.")
                        .define("showWeaponAmmoCounter", true);
                this.weaponAmmoCounterSize =
                        builder.comment("Size of the weapon ammunition counter on your HUD")
                                .defineInRange("weaponAmmoCounterSize", 1.0, 0.01, 4.0);
    ...
    public static class WeaponFireMode {
        ...
        public WeaponFireMode(final ForgeConfigSpec.Builder builder) {
    ...
    public static class WeaponReloadTimer {
        ...
        public WeaponReloadTimer(final ForgeConfigSpec.Builder builder) {
            builder.comment("Configuration for HUD reloading timer bar").push("weaponReloadTimer");
            {
                this.showWeaponReloadTimer = builder.comment(
                        "Display the amount of ammunition your weapon holds and can hold on your HUD.")
                        .define("showWeaponAmmoCounter", true);
                this.weaponReloadTimerSize =
                        builder.comment("Size of the weapon ammunition counter on your HUD")
                                .defineInRange("weaponAmmoCounterSize", 1.0, 0.01, 4.0);
    ...
    public static class WeaponAmmoInspectText {
        public final ForgeConfigSpec.BooleanValue showWeaponAmmoInspectText;
        public final ForgeConfigSpec.DoubleValue weaponAmmoInspectTextSize;

        public final ForgeConfigSpec.DoubleValue x;
        public final ForgeConfigSpec.DoubleValue y;

        public WeaponAmmoInspectText(final ForgeConfigSpec.Builder builder) {
            builder.comment("Configuration for HUD additions").push("weaponAmmoInspectText");
            {
                this.showWeaponAmmoInspectText = builder.comment(
                        "Display the amount of ammunition your weapon holds and can hold on your HUD.")
                        .define("showWeaponAmmoInspectText", true);
                this.weaponAmmoInspectTextSize =
                        builder.comment("Size of the weapon ammunition counter on your HUD")
                                .defineInRange("weaponAmmoInspectTextSize", 1.0, 0.01, 4.0);
    ...
    public static class Particle {
        ...
        public Particle(final ForgeConfigSpec.Builder builder) {
            builder.comment("Properties relating to particles").push("particle");
            {
                this.bulletHoleLifeMin = builder
                        .comment("The minimum duration in ticks before bullet holes will disappear")
                        .defineInRange("bulletHoleLifeMin", 250, 0, Integer.MAX_VALUE);
                this.bulletHoleLifeMax = builder
                        .comment("The maximum duration in ticks before bullet holes will disappear")
                        .defineInRange("bulletHoleLifeMax", 800, 0, Integer.MAX_VALUE);
    ...
    public static class Controls {
        ...
        public Controls(final ForgeConfigSpec.Builder builder) {
    ...
    public static class Quality {
        ...
        public Quality(final ForgeConfigSpec.Builder builder) {
            builder.comment(
                    ...
                    .push("quality");
            {
                this.reducedQualityHotBar = builder.comment(
                        ...
                        .define("reducedQualityHotBar", true);
                this.worldRerenderPiPAlpha = builder.comment(
                        ...
                        .define("worldRerenderPiPAlpha", false);
                // this.reducedGuiScopeQuality = builder.comment("If enabled all main scopes
                // will be unloaded and replaced with lower quality and legacy models, not all
                // scopes maybe replaced with this mode!").define("reducedScopeQuality", false);
                // this.reducedGuiAmmunitionQuality = builder.comment("If enabled all main
                // ammunition will be unloaded and replaced with lower quality and legacy
                // models, not all ammo types maybe replaced with this
                // mode!").define("reducedAmmunitionQuality", false);
                // this.reducedEffects = builder.comment("If enabled all main effects will be
                // disabled such as muzzle flash / smoke and more!").define("reducedEffects",
                // false);
            }
            builder.pop();
        }
    ...
    public static class Gameplay {
        ...
        public Gameplay(final ForgeConfigSpec.Builder builder) {
            builder.comment("Properties relating to gameplay").push("gameplay");
            {
                this.enableGunGriefing = builder.comment(
                        "If enable, allows guns to shoot out glass and remove blocks on explosions")
                        .define("enableGunGriefing", true);
                this.growBoundingBoxAmountV2 = builder.comment(
                        ...
                        .defineInRange("growBoundingBoxAmountV2", 0.0, 0.0, 1.0);
                ...
                this.headShotDamageMultiplier = builder.comment(
                ...
                this.criticalDamageMultiplier = builder.comment(
                        "The value to multiply the damage by if projectile is a critical hit")
                        .defineInRange("criticalDamageMultiplier", 2.0, 1.0, Double.MAX_VALUE);
                this.ignoreLeaves = builder.comment(
                        "If true, projectiles will ignore leaves when checking for collision")
                        .define("ignoreLeaves", true);
                this.enableKnockback = builder.comment(
                ...
                this.safetyExistence = builder.comment(
                        "Enables the safe mode on weapons, false completely nullifies the existence of the safety")
                        .define("safetyExistence", false);

                this.realisticLowPowerFovHandling = builder.comment(
                        "Optics with 0 fov modification will not affect the players fov at all")
                        .define("realisticLowPowerFovHandling", false);
                this.realisticIronSightFovHandling = builder.comment(
                        "Iron sights fov modification will not affect the players fov at all")
                        .define("realisticIronSightFovHandling", false);

                this.realisticAimedBreathing = builder.comment(
                        "Aiming will present a breathing animation, moving the weapon over time, crouch to lower it's effects")
                        .define("realisticAimedBreathing", false);

                this.bulletsIgnoreStandardArmor = builder.comment(
                        "Bullets completely ignore Minecraft armor, forcing you to use our armor system.")
                        .define("bulletsIgnoreStandardArmor", true);
                this.percentDamageIgnoresStandardArmor = builder.comment(
                        "The percent of the damage to be applied standard, AKA Minecraft armor reduces this portion of the damage, while the rest passes through freely, only active when either armor hits 0 or no TaC armor worn at "
                                + "all, 0 = Minecraft armor effectiveness doesn't change, 1 = Minecraft armor never effects bullet damage.")
                        .defineInRange("percentDamageIgnoresStandardArmor", 0.5, 0.0, 1.0);
                this.renderTaCArmor = builder.comment(
                        ...
                        .define("renderTaCArmor", true);
                this.armorBluntDamage = builder.comment(
                        ...
                        .define("armorBluntDamage", true);

                this.forceCameraShakeOnFire = builder.comment(
     ...
     * builder.comment("Properties relating to gameplay").push("gameplay");
     * {
     * this.M1928_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("m1928_trigMax", 0, 0, 10);
     * this.AK47_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("ak47_trigMax", 1, 0, 10);
     * this.M60_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("m60_trigMax", 0, 0, 10);
     * this.DP28_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("dp28_trigMax", 1, 0, 10);
     * this.M16A1_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("m16a1_trigMax", 1, 0, 10);
     * this.AK74_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("ak74_trigMax", 1, 0, 10);
     * this.AR15HM_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("ar15hm_trigMax", 0, 0, 10);
     * this.AR15P_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("ar15p_trigMax", 0, 0, 10);
     * this.VECTOR45_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("vector45_trigMax", 0, 0, 10);
     * this.MICROUZI_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("microuzi_trigMax", 0, 0, 10);
     * this.M4_trigMax = builder.
     * comment("Maximum level of the Trigger Finger enchantment allowed on a weapon"
     * ).defineInRange("m4_trigMax", 0, 0, 10);
     * }
     * builder.pop();
     * }
     * }
    ...
    public static class Network {
        ...
        public Network(final ForgeConfigSpec.Builder builder) {
            builder.comment("Properties relating to network").push("network");
            {
                this.projectileTrackingRange = builder.comment(
                        ...
                        .defineInRange("projectileTrackingRange", 200.0, 1, Double.MAX_VALUE);
            }
            builder.pop();
        }
    }
    ...
    public static class AggroMobs {
        ...
        public AggroMobs(final ForgeConfigSpec.Builder builder) {
            builder.comment("Properties relating to mob aggression").push("aggro_mobs");
            {
                this.enabled = builder.comment(
                        ...
                        .define("enabled", true);
                this.angerHostileMobs = builder.comment(
                ...
                this.exemptEntities =
                        builder.comment("Any mobs of defined will not aggro on shooters")
    ...
    public static class Missiles {
        ...
        public Missiles(final ForgeConfigSpec.Builder builder) {
            builder.comment("Properties relating to missiles").push("missiles");
            {
                this.explosionRadius =
                        builder.comment("The max distance which the explosion is effective to")
    ...
    public static class Grenades {
        ...
        public Grenades(final ForgeConfigSpec.Builder builder) {
    ...
    public static class StunGrenades {
        ...
        public StunGrenades(final ForgeConfigSpec.Builder builder) {
    ...
    public static class Blind {
        ...
        public Blind(final ForgeConfigSpec.Builder builder) {
            builder.comment("Blinding properties of stun grenades").push("blind");
            {
                ...
                this.blindMobs = builder.comment(
    ...
    public static class Deafen {
        ...
        public Deafen(final ForgeConfigSpec.Builder builder) {
            builder.comment("Deafening properties of stun grenades").push("deafen");
            {
                ...
                this.panicMobs = builder.comment(
    ...
    public static class EffectCriteria {
        ...
        public EffectCriteria(final ForgeConfigSpec.Builder builder, final double radius,
                final int durationMax, final int durationMin, final double angleEffect,
                final double angleAttenuationMax, final boolean raytraceOpaqueBlocks) {
            builder.push("effect_criteria");
            {
                this.radius = builder.comment(
    ...
    public static class ProjectileSpread {
        ...
        public ProjectileSpread(final ForgeConfigSpec.Builder builder) {
            builder.comment("Properties relating to projectile spread").push("projectile_spread");
            {
                ...
                this.maxCount = builder.comment("The amount of times a player has to shoot within"
                        + " the spread threshold before the maximum amount of spread is applied. Setting the value higher means it will take longer for the spread to be applied.")
                        .defineInRange("maxCount", 3, 1, Integer.MAX_VALUE);
                this.movementInaccuracy = builder.comment(
                        "Weapon grows more inaccurate depending if the player is in motion (Forward, Strafing, Jumping)")
                        .define("movementInaccuracy", true);
            }
            builder.pop();
        }
    }
        ...
        public Server(final ForgeConfigSpec.Builder builder) {
            builder.push("server");
            {
                builder.comment("Stun Grenade related properties").push("grenade");
                {
                    ...
                    this.alphaFadeThreshold = builder.comment(
                    ...
                    this.soundPercentage = builder.comment(
                    ...
                    this.ringVolume = builder.comment(
                ...
                {
                    this.gunShotMaxDistance =
                            builder.comment("The maximum distance weapons can be heard by players.")
                                    .defineInRange("gunShotMaxDistance", 100, 0, Double.MAX_VALUE);
                    this.reloadingSoundDistance = builder.comment(
                            "The maximum distance reloading a weapon can be heard by players.")
                            .defineInRange("reloadingSoundDistance", 14, 0, Double.MAX_VALUE);
                }
                builder.pop();

                this.enableCameraRecoil =
                        builder.comment("If true, enables camera recoil when firing a weapon")
                                .define("enableCameraRecoil", true);
            }
            builder.pop();
        }
    }
    ...
    static {
        final Pair<Client, ForgeConfigSpec> clientSpecPair =
        ...
        final Pair<Server, ForgeConfigSpec> serverSpecPair =
