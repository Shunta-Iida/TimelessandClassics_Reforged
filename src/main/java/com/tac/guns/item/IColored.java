...
/**
 * A simple interface to allow items to be colored. Implementing this on an item
 * will automatically
 * register an {@link ItemColor} into {@link ItemColors}. If the item this is
 * implemented on is an
 * attachment, it will colored automatically by the color of the weapon if the
 * item does not explicitly
 * have a color set.
 * <p>
 * Author: MrCrayfish
 */
