    ...
    public static void addInformationEvent(ItemTooltipEvent event) {
        ...
        if (stack.getItem() instanceof IAttachment<?>) {
            ...
            if (perks != null && perks.size() > 0) {
                event.getToolTip().add(new TranslatableComponent("perk.tac.title").withStyle(ChatFormatting.GOLD,
                        ChatFormatting.BOLD));
            ...
            if (outputRadius > inputRadius) {
                addPerkN(negativePerks, "perk.tac.sound_radius.negative", new TranslatableComponent("-")
                        .append(new TranslatableComponent("perk.tac.sound_radiusv2", Math.round(outputRadius))
            ...
            if (positivePerks.size() > 0) {
                event.getToolTip().add(new TranslatableComponent("perk.tac.title").withStyle(ChatFormatting.GRAY,
                        ChatFormatting.BOLD));
