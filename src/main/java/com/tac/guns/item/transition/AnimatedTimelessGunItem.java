 ...
 * 
 * public class AnimatedTimelessGunItem extends TimelessGunItem implements
 * IAnimatable,ITimelessAnimated{
 * public static final String CONTROLLER_NAME = "gunStatusController";
 * 
 * public AnimatedTimelessGunItem(Process<Properties> properties,
 ...
 * 
 * private <P extends Item & IAnimatable> PlayState predicate(AnimationEvent<P>
 * event) {
 ...
 * }
 * 
 * public void playAnimation(String animationName, ItemStack stack, boolean
 * coercive){
 * AnimationController controller =
 * GeckoLibUtil.getControllerForStack(this.factory,stack,CONTROLLER_NAME);
