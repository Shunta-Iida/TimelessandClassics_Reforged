...
public class DiscardOffhand {
    ...
    // TODO: Review if this has to be server side, possibly keep this as a server
    // sided force, but we could likely make this more efficent and customizable for
    // the player by running locally first along with
