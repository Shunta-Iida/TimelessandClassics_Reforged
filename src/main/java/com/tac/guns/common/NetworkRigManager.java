...
public class NetworkRigManager extends SimplePreparableReloadListener<Map<ArmorRigItem, Rig>> {
     ...
     *
     * @return true if all registered rigs were able to update their corresponding
     *         gun item
     */
    @OnlyIn(Dist.CLIENT)
    ...
    /**
     * Gets a map of all the registered rigs objects. Note, this is an immutable
     * map.
     *
    ...
    /**
     * Gets a list of all the rigs registered on the client side. Note, this is an
     * immutable list.
     *
