 ...
 *
 *         Offers Dynamic Light functionality emulating portable or static Flood
 *         Lights
 *
 */
// @Mod(modid = "dynamiclights_floodlights", name = "Dynamic Lights Flood
// Light", version = "1.0.3", dependencies = "required-after:dynamiclights")
public class FloodLightSource {
     ...
     *//*
        ...
        *//*
           ...
           * int lightLevel = 15;
           *//* Math.max( *//**//*
                                 * getLightFromItemStack(this.thePlayer.getHeldItemMainhand()),
                                 * getLightFromItemStack(thePlayer.getHeldItemOffhand()
                                 *//**//* ) *//*
                                               * //);
                                               * RayTraceResult mop = this.thePlayer.pick(24,0F,false);//
                                               * rayTraceBlocks(posvec, look);
                                                   ...
                                                   *//**//*
                                                           ...
                                                           *//**//*
                                                                  ...
                                                                  *//*
                                                                     ...
                                                                     * }
                                                                     * 
                                                                     * private void handleLight(PartialLightSource
                                                                     * source, int light, boolean doLight)
                                                                     * {
                                                                     * if (doLight)
                                                                     * {
                                                                     ...
                                                                     * DynamicLights.addLightSource((
                                                                     * IDynamicLightSource) p);
                                                                     * }
                                                                     * else
                                                                     * {
                                                                     * //GunMod.LOGGER.log(
                                                                     * System.out.
                                                                     * println("GAMING GAMING                          GaEw"
                                                                     * );
                                                                     * DynamicLights.removeLightSource((
                                                                     * IDynamicLightSource)p);
                                                                     * }
                                                                     * }
                                                                     * }
                                                                     ...
                                                                     * }
                                                                     * 
                                                                     * private void checkDummyInit(World world, Vector3d
                                                                     * pos)
                                                                     * {
                                                                     ...
                                                                     *//*
                                                                        ...
                                                                        * {
                                                                        * partialLights[i] = new PartialLightSource(new
                                                                        * DummyEntity(world, pos, i));
                                                                        * DynamicLights.addLightSource(partialLights[i])
                                                                        * ;
                                                                        * }
                                                                        *//*
                                                                           * partialLights[0] = new
                                                                           * PartialLightSource(new DummyEntity(world,
                                                                           * pos, 1));
                                                                           * DynamicLights.addLightSource(partialLights[
                                                                           * 0]);
                                                                           * }
                                                                           * }
                                                                           * 
                                                                           *//*
                                                                              * private int
                                                                              * getLightFromItemStack(ItemStack stack)
                                                                              * {
                                                                              * if (stack != null)
                                                                              * {
                                                                              * int r =
                                                                              * itemsMap.retrieveValue(stack.getItem().
                                                                              * getRegistryName(),
                                                                              * stack.getItemDamage());
                                                                              * return r < 0 ? 0 : r;
                                                                              * }
                                                                              ...
                                                                              *//*
                                                                                 * 
                                                                                 * private class PartialLightSource
                                                                                 ...
                                                                                 * }
                                                                                 * 
                                                                                 * private class DummyEntity extends
                                                                                 * Entity
                                                                                 * {
                                                                                 ...
                                                                                 * .create(Integer.MAX_VALUE-i,par1World
                                                                                 * ).getType()
                                                                                 * this.noClip = true;
                                                                                 * this.recalculateSize();
                                                                                 * this.setEntityId(Integer.MAX_VALUE-i)
                                                                                 * ;
                                                                                 * this.setPosition(pos.getX()+0.5D,
                                                                                 ...
                                                                                 * 
                                                                                 * @Override
                                                                                 * public EntitySize getSize(Pose
                                                                                 * poseIn) {
                                                                                 * // To make the entity visible for
                                                                                 * debugging, don't set its size to zero
