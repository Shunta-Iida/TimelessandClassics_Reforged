 ...
 * attachments.
 * See {@link GunModifiers} for examples of how this can be implemented.
 * Implementations can then
 * be passed to "create" method of attachment objects. See
 * {@link Barrel#create(float, IGunModifier...)}
 * <p>
 * Author: Forked from MrCrayfish, continued by Timeless devs
 */
public interface IGunModifier {
    /**
     * Modify the volume of the fire sound. This does not change the distance the
     * sound can be heard
    ...
    /**
     * Determines if the fire sound should be the silenced version. If at one
     * attachment on the
     * weapon has this set to true, it will be silenced regardless if other
     * attachments specify false.
     *
    ...
    /**
     * Modifies the sound radius of the fired sound. It should be noted that if
     * multiple attachments
     * modify the sound radius, the radius given in the arguments may not be exactly
     * the same as the
    ...
    /**
     * Adds additional damage to the weapon. This can be positive or negative
    ...
    /**
     * Adds additional headshot damage to the weapon. This can be positive or
     * negative number, with negative
     * reducing the headshot damage of the weapon.
     *
     * @return additional headshot damage to add on top of the base headshot damage
     *         for this weapon
     */
    ...
    /**
     * Modify the spread when firing a projectile. This will affect the accuracy of
     * weapons and only
    ...
    /**
     * Modify the spread when firing the first shot until the accuracyReset timer is
     * passed.
     *
     * @param spread the current weapon spread
     * @return a new spread for the weapon
    ...
    /**
     * Modify the recoil time of recoil, increasing camera and visual recoil time,
     * making the feel smoother and easier to maintain target holds
     *
     * @return a new spread for the weapon
     */
    ...
    /**
     * Change the gravity of the projectile. The higher the value, the quicker the
     * projectile will
     * fall to the ground.
     *
    ...
    /**
     * Changes the life of the projectile. This is the maximum age before the
     * projectile is removed
     * from the world. The higher the number, the longer it will be in the world
     * (assuming it doesn't
     * collide).
     *
    ...
    /**
     * Changes the amount of recoil given when firing a weapon. This value is
     * multiplied with the recoil
     * value of the weapon. Anything greater than one will result in the weapon
     * having more recoil, while
     * less than one but more than zero will result in less kick. Changing this does
     * have an affect
    ...
    /**
     * Changes the amount of kick given when firing a weapon. This value is
     * multiplied with the kick
     * value of the weapon. Anything greater than one will result in the weapon
     * having more kick, while
     * less than one but more than zero will result in less kick. Changing this does
     * not make the
    ...
    /**
     * Change the speed it takes to look down the sight of the weapon. The higher
     * the speed, the
    ...
    /**
     * Modifies the fire rate of a weapon. The higher the number, the faster the
     * weapon will fire.
     *
    ...
    /**
     * Adds chance that critical damage will occur when hitting an entity with a
     * projectile. This
     * can be positive or negative number, with negative reducing the chance of a
     * critical hit.
     *
