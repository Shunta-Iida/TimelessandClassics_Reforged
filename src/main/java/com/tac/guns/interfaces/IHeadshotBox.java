...
/**
 * This interface used to create hit box definitions of an entity's head. This
 * has to be registered with
 * {@link com.tac.guns.common.BoundingBoxManager#registerHeadshotBox(EntityType, IHeadshotBox)}
 * (EntityType, IHeadshotBox)}
 * in order for projectiles to be able to perform a headshot on the given
 * entity.
 * <p>
...
public interface IHeadshotBox<T extends Entity> {
    /**
     * Gets a bounding box of the given entity's head in the world. This method can
     * either return an
