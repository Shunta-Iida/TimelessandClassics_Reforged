...
public class ModItems {
    ...
    // public static final RegistryObject<TimelessGunItem> M1894 =
    // REGISTER.register("m1894", () -> new TimelessGunItem(properties ->
    // propertiestab(GunMod.SNIPER)));
    // public static final RegistryObject<Item> M1928 = REGISTER.register("m1928",
    // () -> new TimelessGunItem(properties -> propertiestab(GunMod.SMG)));
    ...
    // public static final RegistryObject<Item> DB_LONG =
    // REGISTER.register("db_long", () -> new TimelessGunItem(properties ->
    // propertiestab(GunMod.SHOTGUN)));
    // public static final RegistryObject<Item> WALTHER_PPK =
    // REGISTER.register("walther_ppk", () -> new TimelessPistolGunItem(properties
    // -> propertiestab(GunMod.PISTOL)));
    ...
    // public static final RegistryObject<Item> PPSH_41 =
    // REGISTER.register("ppsh_41", () -> new TimelessGunItem(properties ->
    // propertiestab(GunMod.SMG)));
    public static final RegistryObject<Item> QBZ_95 = REGISTER.register("qbz_95",
            () -> new TimelessGunItem(properties -> properties.tab(GunMod.RIFLE)));
    // public static final RegistryObject<Item> SPRINGFIELD_1903 =
    // REGISTER.register("springfield_1903", () -> new
    // TimelessOldRifleGunItem(properties -> propertiestab(GunMod.SNIPER)));
    ...
    // () -> new TimelessGunItem(properties -> propertiestab(GunMod.SNIPER)));
    // public static final RegistryObject<Item> SMLE_III =
    ...
    public static final RegistryObject<Item> MK14 = REGISTER.register("mk14",
            () -> new TimelessGunItem(properties -> properties.tab(GunMod.RIFLE)));
    // public static final RegistryObject<Item> SPAS_12 =
    // REGISTER.register("spas_12", () -> new TimelessGunItem(properties ->
    // propertiestab(GunMod.SHOTGUN)));
    ...
    // () -> new TimelessPistolGunItem(properties -> propertiestab(GunMod.PISTOL)));
    ...
    // -> new TimelessPistolGunItem(properties -> propertiestab(GunMod.PISTOL)));
    // public static final RegistryObject<Item> QSZ92G1 =
    // REGISTER.register("qsz92g1", () -> new TimelessPistolGunItem(properties ->
    // propertiestab(GunMod.PISTOL)));
    // public static final RegistryObject<Item> KAR98 = REGISTER.register("kar98",
    ...
    // public static final RegistryObject<Item> PKP_PENCHENBERG =
    ...
    // public static final RegistryObject<Item> DE_LISLE =
    // REGISTER.register("de_lisle", () -> new TimelessOldRifleGunItem(properties ->
    // propertiestab(GunMod.SNIPER), GunModifiers.DE_LISLE_MOD));
    // public static final RegistryObject<Item> M1_GARAND =
    // REGISTER.register("m1_garand", () -> new M1GunItem(properties ->
    // propertiestab(GunMod.RIFLE), GunModifiers.M1_GARAND_MOD));
    ...
    // -> new TimelessGunItem(properties -> propertiestab(GunMod.EXPLOSIVES),
    // GunModifiers.M79_MOD));
    // public static final RegistryObject<GunItem> MGL_40MM =
    // REGISTER.register("mgl_40mm", () -> new TimelessGunItem(properties ->
    // propertiestab(GunMod.EXPLOSIVES), true, GunModifiers.MGL_40MM_MOD));
    ...
    // new TimelessPistolGunItem(properties -> propertiestab(GunMod.PISTOL)));
    // public static final RegistryObject<Item> STEN_OSS =
    // REGISTER.register("sten_mk_ii_oss", () -> new TimelessGunItem(properties ->
    // propertiestab(GunMod.SMG), GunModifiers.STEN_OSS_MOD));
    // public static final RegistryObject<Item> ESPADON =
    ...
    // PistolScopeItem(Scope.create(new ScopeZoomData[]{new
    // ScopeZoomData(0.00F,0.00F)}, 1.645F,0.325, "microholo",
    // GunModifiers.MICRO_HOLO_SIGHT_ADS).viewFinderOffset(0.685).viewFinderOffsetSpecial(0.685),
    // new Item.Properties().maxStackSize(1)tab(GunMod.GROUP)));
    ...
    public static final RegistryObject<Item> WEIGHTED_STOCK = REGISTER.register("weighted_stock",
            () -> new StockItem(Stock.create(GunModifiers.HEAVY_STOCK_MODIFIER),
                    new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    ...
    public static final RegistryObject<Item> ARMOR_R2 = REGISTER.register("armor_r2",
            () -> new ArmorRigItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<Item> ARMOR_R3 = REGISTER.register("armor_r3",
            () -> new ArmorRigItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<Item> ARMOR_R4 = REGISTER.register("armor_r4",
            () -> new ArmorRigItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<Item> ARMOR_R5 = REGISTER.register("armor_r5",
            () -> new ArmorRigItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    // public static final RegistryObject<Item> ARMOR_REPAIR_PLATE_TEST =
    // REGISTER.register("armor_plate_test", () -> new ArmorPlateItem(new
    ...
    // REGISTER.register("ultimate_certificate",() -> new Item(new
    // Item.Properties().maxStackSize(16)tab(GunMod.GROUP)));
    /* Skin */
    // public static final RegistryObject<Item> SKIN_CUSTOM =
    // REGISTER.register("skin_custom",
